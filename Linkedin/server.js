...
const session = require('express-session')({ secret: 'Whatever you want your session secret to be', resave: true, saveUninitialized: true});
...
//start the server
app.listen(PORT, () => {
  console.log('LinkedIn example running on port', PORT);
});
